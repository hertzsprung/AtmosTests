...
class Advect:
    def __init__(self):
        ...
        self.meshBtf5000_3000m = TerrainFollowingMesh('advect-mesh-btf-5000-3000m', self.meshNoOrography5000, os.path.join('src/advect/mesh-btf-3000m'))
        self.meshBtf2500_3000m = TerrainFollowingMesh('advect-mesh-btf-2500-3000m', self.meshNoOrography2500, os.path.join('src/advect/mesh-btf-3000m'))
        self.meshBtf2000_3000m = TerrainFollowingMesh('advect-mesh-btf-2000-3000m', self.meshNoOrography2000, os.path.join('src/advect/mesh-btf-3000m'))
        self.meshBtf1250_3000m = TerrainFollowingMesh('advect-mesh-btf-1250-3000m', self.meshNoOrography1250, os.path.join('src/advect/mesh-btf-3000m'))
        self.meshBtf1000_3000m = TerrainFollowingMesh('advect-mesh-btf-1000-3000m', self.meshNoOrography1000, os.path.join('src/advect/mesh-btf-3000m'))
        self.meshBtf667_3000m = TerrainFollowingMesh('advect-mesh-btf-667-3000m', self.meshNoOrography667, os.path.join('src/advect/mesh-btf-3000m'))
        self.meshBtf500_3000m = TerrainFollowingMesh('advect-mesh-btf-500-3000m', self.meshNoOrography500, os.path.join('src/advect/mesh-btf-3000m'))
        self.meshBtf333_3000m = TerrainFollowingMesh('advect-mesh-btf-333-3000m', self.meshNoOrography333, os.path.join('src/advect/mesh-btf-3000m'))
        self.meshBtf250_3000m = TerrainFollowingMesh('advect-mesh-btf-250-3000m', self.meshNoOrography250, os.path.join('src/advect/mesh-btf-3000m'))
        ...
        self.meshes = [
                ...
                self.meshBtf5000_3000m, self.meshBtf2500_3000m, self.meshBtf2000_3000m,
                self.meshBtf1250_3000m, self.meshBtf1000_3000m, self.meshBtf667_3000m,
                self.meshBtf500_3000m, self.meshBtf333_3000m, self.meshBtf250_3000m,
